...
def check_events(ai_settings, screen, stats, score_board, play_button, ship, aliens,
        bullets):
...
def update_screen(ai_settings, screen, stats, score_board, ship, aliens, bullets,
        play_button):
...
def update_bullets(ai_settings, screen, stats, score_board, ship, aliens, bullets):
    ...
    check_bullet_alien_collisions(ai_settings, screen, stats, score_board, ship,
        aliens, bullets)
...
def check_bullet_alien_collisions(ai_settings, screen, stats, score_board, ship,
        aliens, bullets):
